  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "price-flash-up": "priceFlashUp .6s ease",
        "price-flash-down": "priceFlashDown .6s ease",
      },
      keyframes: {
        fadeIn:  { from: { opacity: "0" }, to: { opacity: "1" } },
        slideUp: { from: { opacity: "0", transform: "translateY(8px)" }, to: { opacity: "1", transform: "translateY(0)" } },
        ticker: { "0%": { transform: "translateX(0)" }, "100%": { transform: "translateX(-50%)" } },
        priceFlashUp: { "0%": { color: "#22c55e" }, "100%": { color: "inherit" } },
        priceFlashDown: { "0%": { color: "#ef4444" }, "100%": { color: "inherit" } },
      },
    },
  },
  plugins: [],
